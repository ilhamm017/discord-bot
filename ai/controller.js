...
const COMPACT_SYSTEM_PROMPT = [
    ...
    "Kalau user minta info terbaru atau perlu verifikasi sumber (termasuk pertanyaan tanggal event/kalender seperti 1 Syawal/Idul Fitri), pakai tool searchWeb atau browserosSearch lalu browserosFetchPage.",
